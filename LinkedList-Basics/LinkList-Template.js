...
class LinkedList {
  ...
  // Add additional method to check for existence in LinkedList using existing code patterns---> list.contains('a') === true && list.contains('z') === false
  contains(target) {
    let curr = this.head;
    while (curr !== null) {
      if (curr.val === target) {
